...
<head>
    ...
    <title>Catastro - Buscar Usuario</title>
    <link rel="stylesheet" href="../css/estilos.css?v=<?php echo time(); ?>">
    <script src="../javascript/buscar_usuario.js?v=<?php echo time(); ?>" defer></script>
</head>
<body class="dashboard-page">
   ...
   <nav class="nav-container-canva">
    ...
    <div class="tabla-container-canva">
        <h2>Búsqueda Inteligente de Usuarios</h2>
        <p>Localiza cuentas del personal de forma instantánea buscando por ID o por nombre de usuario (Login).</p>

        <div class="buscador-container">
            <input type="text" id="input_buscar" class="input-buscador" placeholder="🔍 Escribe el ID o nombre del usuario a localizar...">
        </div>
        ...
        <div class="table-responsive">
            <table class="tabla-resumen tabla-padron">
                ...
                <tbody id="resultado_busqueda">
                    <tr>
                        <td colspan="4" class="td-empty">Escribe en la barra para buscar un usuario...</td>
                    </tr>
                </tbody>
            </table>
        </div>
