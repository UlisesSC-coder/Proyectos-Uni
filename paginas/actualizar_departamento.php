<?php
	...
	$departamento = strtoupper(trim($_POST["txt_departamento"])); //Se convierte a MAYUSCULAS usando la función  strtoupper()
        ...
        <fieldset style="width: 90%;"    >
            <legend><?php echo ($mensaje); ?></legend>
                <div>
				    ...
				    <br />
					<br />
                    <a href="reporte_editar_departamentos.php">REPORTE GENERAL DE DEPARTAMENTOS</a>
                </div>
        </fieldset> 
     </div>
  </div>
