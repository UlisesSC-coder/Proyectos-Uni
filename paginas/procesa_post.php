<?php
  ...
  // Se recuperan con $_POST["  "] si viene de 1 formulario

  $NumeroEmpleado = $_POST["txtnumero"];
  $NombreEmpleado = $_POST["txtnombre"];
  $SexoEmpleado = $_POST["combo_sexo"];
...
<div id="wrapper">
   ...
   <div id="caja3">Formulario para la PRACTICA DE POST</div>
   ...
   <div id="caja4">
     <div id="texto1"><br />
        ...
        <legend>INFORMACION RECUPERADA CON POST&nbsp;
        </legend>
	  <?php
	      echo "<br />";
		  echo "<br />";
          echo "Número de empleado: " . $NumeroEmpleado . "<br>";
		  echo "Nombre de empleado: " . $NombreEmpleado . "<br>";
		  echo "Sexo de empleado: " . $SexoEmpleado . "<br>";
      ?>      
        </fieldset> 
     </div>
  </div>
