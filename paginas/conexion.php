<?php
    ...
    $password = "hola123";      // ----- Password para entrar a la BD
    $BasedeDatos = "prograweb2026"; // ----- Nombre de tu base de datos
...
try {
    ...
    //http://localhost/prograweb2025b/paginas/conexion.php
    //Programado por: ABRAHAM VEGA TAPIA -- Programacion web 2025b ********************
?>